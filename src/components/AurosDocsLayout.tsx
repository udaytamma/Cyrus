...
interface AurosDocsLayoutProps {
...
const navigation: NavSection[] = [
  {
    title: "Auros",
    icon: "🎯",
    items: [{ title: "Auros", href: "/docs/auros" }],
  },
  {
    title: "Getting Started",
    items: [
      { title: "Overview", href: "/docs/auros" },
      { title: "Quick Start", href: "/docs/auros/getting-started" },
      { title: "Architecture", href: "/docs/auros/architecture" },
    ],
  },
  {
    title: "Technical Reference",
    items: [
      { title: "API Reference", href: "/docs/auros/api-reference" },
      { title: "Data Model", href: "/docs/auros/data-model" },
      { title: "AI Pipeline", href: "/docs/auros/ai-pipeline" },
    ],
  },
  {
    title: "Implementation",
    items: [
      { title: "Build Phases", href: "/docs/auros/build-phases" },
      { title: "Scraper Design", href: "/docs/auros/scraper-design" },
      { title: "Dashboard UI", href: "/docs/auros/dashboard-ui" },
    ],
  },
];
...
export function AurosDocsLayout({ children }: AurosDocsLayoutProps) {
  const pathname = usePathname();
  const [expandedSections, setExpandedSections] = useState<Record<string, boolean>>({
    Auros: true,
    "Getting Started": true,
    "Technical Reference": true,
    Implementation: true,
  });
