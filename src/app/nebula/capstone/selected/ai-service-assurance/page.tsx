    ...
    >
      <div className="max-w-[1000px] mx-auto">
        <div className="flex justify-between items-center mb-6 flex-wrap gap-4">
          ...
          <Link href="/nebula/capstone/chatgpt/ai-service-assurance" className="text-sm text-primary hover:underline">
        ...
        <header className="mb-8 pb-6 border-b border-border">
          <div className="flex flex-wrap gap-2 mb-4">
            <span className="px-2.5 py-1 rounded-md text-xs font-medium bg-green-500/15 text-green-600 dark:text-green-400">Telecom</span>
            <span className="px-2.5 py-1 rounded-md text-xs font-medium bg-pink-500/15 text-pink-600 dark:text-pink-400">ML/Anomaly Detection</span>
          ...
          <h1 className="text-2xl md:text-3xl font-bold text-foreground">
            <span className="mr-3">✅</span>AI-Powered Service Assurance
          </h1>
        ...
        <section className="mb-8 p-6 bg-card rounded-xl border border-border">
          ...
          <div className="space-y-4 text-muted-foreground">
            ...
            <ul className="list-disc list-inside space-y-1 ml-4">
              <li><strong className="text-foreground">Best For:</strong> Platform TPM roles, infrastructure teams, SRE-adjacent positions</li>
              <li><strong className="text-foreground">Interview Value:</strong> ML model management, reliability engineering, proactive monitoring</li>
              <li><strong className="text-foreground">Differentiation:</strong> Predictive (vs reactive) approach + telecom scale + ML expertise</li>
              <li><strong className="text-foreground">Synergy:</strong> Pairs with Ops Co-Pilot for complete proactive + reactive coverage</li>
            </ul>
          </div>
        </section>

        <div className="flex justify-between items-center mt-8 pt-6 border-t border-border">
          <Link href="/nebula/capstone/selected/ops-copilot" className="text-sm text-muted-foreground hover:text-foreground transition-colors">← Prev: Ops Co-Pilot</Link>
          <Link href="/nebula/capstone/selected/fraud-detection" className="text-sm text-muted-foreground hover:text-foreground transition-colors">Next: Fraud Detection →</Link>
        </div>
      </div>
    </CapstoneLayout>
  );
