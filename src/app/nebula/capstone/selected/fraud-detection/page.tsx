    ...
    >
      <div className="max-w-[1000px] mx-auto">
        <div className="flex justify-between items-center mb-6 flex-wrap gap-4">
          ...
          <Link href="/nebula/capstone/claude/fraud-detection" className="text-sm text-primary hover:underline">
        ...
        <header className="mb-8 pb-6 border-b border-border">
          <div className="flex flex-wrap gap-2 mb-4">
            <span className="px-2.5 py-1 rounded-md text-xs font-medium bg-blue-500/15 text-blue-600 dark:text-blue-400">AI/ML TPM</span>
            <span className="px-2.5 py-1 rounded-md text-xs font-medium bg-red-500/15 text-red-600 dark:text-red-400">Risk Management</span>
          ...
          <h1 className="text-2xl md:text-3xl font-bold text-foreground">
            <span className="mr-3">🛡️</span>Real-time Fraud Detection
          </h1>
        ...
        <section className="mb-8 p-6 bg-card rounded-xl border border-border">
          ...
          <div className="space-y-4 text-muted-foreground">
            ...
            <ul className="list-disc list-inside space-y-1 ml-4">
              <li><strong className="text-foreground">Best For:</strong> Any Mag7 TPM role - covers Platform, Product, and technical leadership</li>
              <li><strong className="text-foreground">Interview Value:</strong> Complete coverage - technical depth, business judgment, stakeholder complexity, risk management</li>
              <li><strong className="text-foreground">Differentiation:</strong> Real-time ML + explainability + regulated domain = rare combination</li>
              <li><strong className="text-foreground">Priority:</strong> Should be lead project in portfolio due to breadth and depth</li>
            </ul>
          </div>
        </section>

        <div className="flex justify-between items-center mt-8 pt-6 border-t border-border">
          <Link href="/nebula/capstone/selected/ai-service-assurance" className="text-sm text-muted-foreground hover:text-foreground transition-colors">← Prev: Service Assurance</Link>
          <Link href="/nebula/capstone/selected/churn-upsell" className="text-sm text-muted-foreground hover:text-foreground transition-colors">Next: Churn & Upsell →</Link>
        </div>
      </div>
    </CapstoneLayout>
  );
