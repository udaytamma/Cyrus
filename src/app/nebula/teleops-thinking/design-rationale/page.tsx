...
export default function TeleOpsDesignRationale() {
  return (
    <TeleOpsThinkingLayout
      title="Design Rationale - TeleOps"
...
{`"confidence_scores": {"link congestion...": 0.55}`}
      ...
      <div className="flex justify-between gap-4 mt-8 pt-6 border-t border-border">
        <Link
          href="/nebula/teleops-thinking/checklist"
        ...
        >
          <span className="group-hover:text-primary transition-colors">&larr; Previous: Checklist</span>
        </Link>
        <Link
          href="/nebula/teleops-thinking"
          className="group px-4 py-2 bg-gradient-to-r from-muted/50 to-transparent border border-border rounded-lg text-sm text-muted-foreground hover:border-primary/50 transition-all"
        >
          <span className="group-hover:text-primary transition-colors">Back to Overview &rarr;</span>
        </Link>
      </div>
    </TeleOpsThinkingLayout>
  );
