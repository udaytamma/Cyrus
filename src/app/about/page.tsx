...
export const metadata: Metadata = {
  title: "About",
  description: "Learn more about Uday Tamma - Technical Program Manager and Software Engineer.",
};
        ...
        <div className="mx-auto max-w-4xl px-4 sm:px-6">
          <div className="rounded-2xl border border-border bg-card p-8 text-center sm:p-12">
            ...
            <p className="mx-auto mb-6 max-w-lg text-muted-foreground">
              This page is currently being renovated. The content is out getting
              a latte and reviewing its life choices. It promised to be back
              soon with a proper biography, impressive credentials, and maybe
              even a professional headshot.
            </p>

            <div className="mx-auto mb-8 max-w-md rounded-lg bg-muted/50 p-4">
              <p className="text-sm text-muted-foreground">
                <span className="font-medium text-foreground">In the meantime:</span>{" "}
                Check out my projects to see what I&apos;ve been building, or
                read the blog for my technical writing.
              </p>
            </div>
            ...
            <div className="mb-8 grid gap-4 sm:grid-cols-3">
              ...
              <div className="rounded-lg border border-border bg-background p-4">
                <div className="text-2xl font-bold text-primary">Telecom</div>
                <div className="text-sm text-muted-foreground">Domain Expert</div>
              </div>
              <div className="rounded-lg border border-border bg-background p-4">
